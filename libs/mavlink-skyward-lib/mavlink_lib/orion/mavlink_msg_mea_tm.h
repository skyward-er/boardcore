...
typedef struct __mavlink_mea_tm_t {
 ...
 float apogee_target; /*< [m] Target apogee*/
 uint8_t state; /*<  MEA current state*/
} mavlink_mea_tm_t;

#define MAVLINK_MSG_ID_MEA_TM_LEN 41
#define MAVLINK_MSG_ID_MEA_TM_MIN_LEN 41
#define MAVLINK_MSG_ID_207_LEN 41
#define MAVLINK_MSG_ID_207_MIN_LEN 41

#define MAVLINK_MSG_ID_MEA_TM_CRC 16
#define MAVLINK_MSG_ID_207_CRC 16
...
#define MAVLINK_MESSAGE_INFO_MEA_TM { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_mea_tm_t, timestamp) }, \
         { "state", NULL, MAVLINK_TYPE_UINT8_T, 0, 40, offsetof(mavlink_mea_tm_t, state) }, \
         ...
         { "min_burn_time", NULL, MAVLINK_TYPE_UINT32_T, 0, 28, offsetof(mavlink_mea_tm_t, min_burn_time) }, \
         { "max_burn_time", NULL, MAVLINK_TYPE_UINT32_T, 0, 32, offsetof(mavlink_mea_tm_t, max_burn_time) }, \
         { "apogee_target", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_mea_tm_t, apogee_target) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MEA_TM { \
 ...
 * @param apogee_target [m] Target apogee
...
static inline uint16_t mavlink_msg_mea_tm_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint8_t state, float kalman_x0, float kalman_x1, float kalman_x2, float mass, float corrected_pressure, uint32_t min_burn_time, uint32_t max_burn_time, float apogee_target)
{
    ...
    _mav_put_uint32_t(buf, 28, min_burn_time);
    _mav_put_uint32_t(buf, 32, max_burn_time);
    _mav_put_float(buf, 36, apogee_target);
    _mav_put_uint8_t(buf, 40, state);
...
{
    return mavlink_msg_mea_tm_pack(system_id, component_id, msg, mea_tm->timestamp, mea_tm->state, mea_tm->kalman_x0, mea_tm->kalman_x1, mea_tm->kalman_x2, mea_tm->mass, mea_tm->corrected_pressure, mea_tm->min_burn_time, mea_tm->max_burn_time, mea_tm->apogee_target);
}
...
{
    return mavlink_msg_mea_tm_pack_chan(system_id, component_id, chan, msg, mea_tm->timestamp, mea_tm->state, mea_tm->kalman_x0, mea_tm->kalman_x1, mea_tm->kalman_x2, mea_tm->mass, mea_tm->corrected_pressure, mea_tm->min_burn_time, mea_tm->max_burn_time, mea_tm->apogee_target);
}
...
static inline void mavlink_msg_mea_tm_send(mavlink_channel_t chan, uint64_t timestamp, uint8_t state, float kalman_x0, float kalman_x1, float kalman_x2, float mass, float corrected_pressure, uint32_t min_burn_time, uint32_t max_burn_time, float apogee_target)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MEA_TM_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mea_tm_send(chan, mea_tm->timestamp, mea_tm->state, mea_tm->kalman_x0, mea_tm->kalman_x1, mea_tm->kalman_x2, mea_tm->mass, mea_tm->corrected_pressure, mea_tm->min_burn_time, mea_tm->max_burn_time, mea_tm->apogee_target);
#else
 ...
 */
static inline void mavlink_msg_mea_tm_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint8_t state, float kalman_x0, float kalman_x1, float kalman_x2, float mass, float corrected_pressure, uint32_t min_burn_time, uint32_t max_burn_time, float apogee_target)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field min_burn_time from mea_tm message
 *
 * @return [ms] Minimum burn time
 */
static inline uint32_t mavlink_msg_mea_tm_get_min_burn_time(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  28);
}

/**
 * @brief Get field max_burn_time from mea_tm message
 *
 * @return [ms] Maximum burn time
 */
static inline uint32_t mavlink_msg_mea_tm_get_max_burn_time(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint32_t(msg,  32);
}

/**
 * @brief Get field apogee_target from mea_tm message
 *
 * @return [m] Target apogee
 */
static inline float mavlink_msg_mea_tm_get_apogee_target(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mea_tm_decode(const mavlink_message_t* msg, mavlink_mea_tm_t* mea_tm)
{
    ...
    mea_tm->min_burn_time = mavlink_msg_mea_tm_get_min_burn_time(msg);
    mea_tm->max_burn_time = mavlink_msg_mea_tm_get_max_burn_time(msg);
    mea_tm->apogee_target = mavlink_msg_mea_tm_get_apogee_target(msg);
