...
#define MAVLINK_MSG_ID_PAYLOAD_STATS_TM_LEN 167
#define MAVLINK_MSG_ID_PAYLOAD_STATS_TM_MIN_LEN 167
#define MAVLINK_MSG_ID_211_LEN 167
#define MAVLINK_MSG_ID_211_MIN_LEN 167

#define MAVLINK_MSG_ID_PAYLOAD_STATS_TM_CRC 247
#define MAVLINK_MSG_ID_211_CRC 247
...
#define MAVLINK_MESSAGE_INFO_PAYLOAD_STATS_TM { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_payload_stats_tm_t, timestamp) }, \
         ...
         { "wing_algorithm", NULL, MAVLINK_TYPE_UINT8_T, 0, 154, offsetof(mavlink_payload_stats_tm_t, wing_algorithm) }, \
         ...
         { "nas_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 155, offsetof(mavlink_payload_stats_tm_t, nas_state) }, \
         { "wnc_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 156, offsetof(mavlink_payload_stats_tm_t, wnc_state) }, \
         { "pin_launch", NULL, MAVLINK_TYPE_UINT8_T, 0, 157, offsetof(mavlink_payload_stats_tm_t, pin_launch) }, \
         { "pin_nosecone", NULL, MAVLINK_TYPE_UINT8_T, 0, 158, offsetof(mavlink_payload_stats_tm_t, pin_nosecone) }, \
         { "cutter_presence", NULL, MAVLINK_TYPE_UINT8_T, 0, 159, offsetof(mavlink_payload_stats_tm_t, cutter_presence) }, \
         { "log_number", NULL, MAVLINK_TYPE_INT16_T, 0, 152, offsetof(mavlink_payload_stats_tm_t, log_number) }, \
         { "log_good", NULL, MAVLINK_TYPE_UINT8_T, 0, 160, offsetof(mavlink_payload_stats_tm_t, log_good) }, \
         { "main_board_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 161, offsetof(mavlink_payload_stats_tm_t, main_board_state) }, \
         { "motor_board_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 162, offsetof(mavlink_payload_stats_tm_t, motor_board_state) }, \
         { "main_can_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 163, offsetof(mavlink_payload_stats_tm_t, main_can_status) }, \
         { "motor_can_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 164, offsetof(mavlink_payload_stats_tm_t, motor_can_status) }, \
         { "rig_can_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 165, offsetof(mavlink_payload_stats_tm_t, rig_can_status) }, \
         { "hil_state", NULL, MAVLINK_TYPE_UINT8_T, 0, 166, offsetof(mavlink_payload_stats_tm_t, hil_state) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PAYLOAD_STATS_TM { \
                               ...
                               uint64_t timestamp, uint64_t liftoff_ts, uint64_t liftoff_max_acc_ts, float liftoff_max_acc, uint64_t max_speed_ts, float max_speed, float max_speed_altitude, uint64_t max_mach_ts, float max_mach, uint64_t apogee_ts, float apogee_lat, float apogee_lon, float apogee_alt, uint64_t apogee_max_acc_ts, float apogee_max_acc, float wing_target_lat, float wing_target_lon, float wing_active_target_n, float wing_active_target_e, uint8_t wing_algorithm, uint64_t dpl_ts, float dpl_alt, uint64_t dpl_max_acc_ts, float dpl_max_acc, float ref_lat, float ref_lon, float ref_alt, float min_pressure, float cpu_load, uint32_t free_heap, uint8_t nas_state, uint8_t wnc_state, uint8_t pin_launch, uint8_t pin_nosecone, uint8_t cutter_presence, int16_t log_number, uint8_t log_good, uint8_t main_board_state, uint8_t motor_board_state, uint8_t main_can_status, uint8_t motor_can_status, uint8_t rig_can_status, uint8_t hil_state)
{
    ...
    _mav_put_int16_t(buf, 152, log_number);
    _mav_put_uint8_t(buf, 154, wing_algorithm);
    _mav_put_uint8_t(buf, 155, nas_state);
    _mav_put_uint8_t(buf, 156, wnc_state);
    _mav_put_uint8_t(buf, 157, pin_launch);
    _mav_put_uint8_t(buf, 158, pin_nosecone);
    _mav_put_uint8_t(buf, 159, cutter_presence);
    _mav_put_uint8_t(buf, 160, log_good);
    _mav_put_uint8_t(buf, 161, main_board_state);
    _mav_put_uint8_t(buf, 162, motor_board_state);
    _mav_put_uint8_t(buf, 163, main_can_status);
    _mav_put_uint8_t(buf, 164, motor_can_status);
    _mav_put_uint8_t(buf, 165, rig_can_status);
    _mav_put_uint8_t(buf, 166, hil_state);
...
{
    return _MAV_RETURN_int16_t(msg,  152);
}
 ...
 */
static inline uint8_t mavlink_msg_payload_stats_tm_get_log_good(const mavlink_message_t* msg)
{
