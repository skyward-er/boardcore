...
set(BOARD_NAME stm32f767zi_arp_gs_no_xram)
set(ARCH_NAME cortexM7_stm32f7)

# Base directories with header files for this board
set(ARCH_PATH ${KPATH}/arch/${ARCH_NAME}/common)
set(BOARD_PATH ${BOARDCORE_PATH}/src/bsps/stm32f767zi_arp_gs)
set(BOARD_CONFIG_PATH ${BOARDCORE_PATH}/src/bsps/stm32f767zi_arp_gs/config)
