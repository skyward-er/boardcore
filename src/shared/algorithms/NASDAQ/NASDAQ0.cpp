...
void NASDAQ0::step()
{
  ...
  rtb_LUFactorization_o3 = (NASDAQ0_DW.UnitDelay3_DSTATE >
    NASDAQ0_P.Switch_Threshold);
  ...
  rtb_AND = ((NASDAQ0_P.Constant_Value_j != 0.0) && rtb_LUFactorization_o3);
  ...
  rtb_AND_l = ((NASDAQ0_P.Constant_Value != 0.0) && rtb_LUFactorization_o3);
  ...
  if (u0 > NASDAQ0_P.Saturation_UpperSat) {
    ...
    NASDAQ0_DW.UnitDelay3_DSTATE = NASDAQ0_P.Saturation_UpperSat;
  } else if (u0 < NASDAQ0_P.Saturation_LowerSat) {
    // Update for UnitDelay: '<S1>/Unit Delay3'
    NASDAQ0_DW.UnitDelay3_DSTATE = NASDAQ0_P.Saturation_LowerSat;
  } else {
    // Update for UnitDelay: '<S1>/Unit Delay3'
  ...
  // Bias: '<S1>/Bias3' incorporates:
  //   UnitDelay: '<S1>/Unit Delay4'

  u0 = static_cast<int8_t>(NASDAQ0_DW.UnitDelay4_DSTATE + NASDAQ0_P.Bias3_Bias);

  // Saturate: '<S1>/Saturation3'
  if (u0 > NASDAQ0_P.Saturation3_UpperSat) {
    // Update for UnitDelay: '<S1>/Unit Delay4'
    NASDAQ0_DW.UnitDelay4_DSTATE = NASDAQ0_P.Saturation3_UpperSat;
  } else if (u0 < NASDAQ0_P.Saturation3_LowerSat) {
    // Update for UnitDelay: '<S1>/Unit Delay4'
    NASDAQ0_DW.UnitDelay4_DSTATE = NASDAQ0_P.Saturation3_LowerSat;
  } else {
    // Update for UnitDelay: '<S1>/Unit Delay4'
    NASDAQ0_DW.UnitDelay4_DSTATE = u0;
  }
...
{
  {
    ...
    NASDAQ0_DW.UnitDelay4_DSTATE = NASDAQ0_P.UnitDelay4_InitialCondition;
