...
public:
    ...
    struct P_NASDAQ0_T
    {
        ...
        int8_t
            Saturation1_UpperSat;  // Computed Parameter: Saturation1_UpperSat
                                   //  Referenced by: '<S1>/Saturation1'

        int8_t
            Saturation1_LowerSat;  // Computed Parameter: Saturation1_LowerSat
                                   //  Referenced by: '<S1>/Saturation1'
    ...
    NASDAQOut getNASDAQ_Out() const { return NASDAQ0_Y.NASDAQOut_l; }

    // Root outport: '<Root>/NASDAQ Logs OBSW' get method
    NASDAQLogs getNASDAQ_Logs_OBSW() const { return NASDAQ0_Y.NASDAQLogsOBSW; }

    // Block parameters get method
    const P_NASDAQ0_T& getBlockParameters() const { return NASDAQ0_P; }
...
private:
    ...
    static void NASDAQ0_NoCorrectionStep(bool rtu_Enable,
...
//  Unit (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding')    - opens
//  subsystem CHADsimulator/Control Units/Control Units SIM/Main Control Unit
//  (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding
//  hilite_system('CHADsimulator/Control Units/Control Units SIM/Main Control
//  Unit (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding/Kp') - opens
//  and selects block Kp
//
//  Here is the system hierarchy for this model
//
//  '<Root>' : 'CHADsimulator/Control Units/Control Units SIM/Main Control Unit
//  (Sim)/Descent Navigation /Descent NAS'
...
//  (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding/Correction Step'
//  '<S3>'   : 'CHADsimulator/Control Units/Control Units SIM/Main Control Unit
//  (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding/Prediction Step'
//  '<S4>'   : 'CHADsimulator/Control Units/Control Units SIM/Main Control Unit
//  (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding/Correction
//  Step/ADA Correction'
//  '<S5>'   : 'CHADsimulator/Control Units/Control Units SIM/Main Control Unit
//  (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding/Correction
//  Step/Baro Correction'
...
//  (Sim)/Descent Navigation /Descent NAS/NASDAQ - Autocoding/Correction
//  Step/GPS Correction/Active Correction Step/Residual - GPS Correction/Degrees
//  to Radians1'
