...
void ADA_Algorithm0::step()
{
 ...
 ADAState ADA_Algorithm0::getState(){
    ADAState outputAdaState = ADA_Algorithm0_Y.ADAState_d;
    outputAdaState.timestamp = Boardcore::TimestampTimer::getTimestamp();
    return outputAdaState;
  }
