...
//    '<S54>/Correction'
//
void ANAS0::ANAS0_Correction(float rty_S[9], const float rtu_PH_prev[9],
                             float rty_K[9])
{
...
//    '<S178>/No correction'
//
void ANAS0::ANAS0_Nocorrection_d(float rtu_R, const float rtu_PH_prev[6],
                                 float rty_K[6], float* rty_S,
...
void ANAS0::step()
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            rtb_Selector[i_0 + 6 * i] =
                ANAS0_U.ANASReference_f.InitialCovariance[9 * i + i_0];
        }
    ...
    for (i = 0; i < 36; i++)
    {
        ...
        rtb_Transpose_e[i] =
            rtb_Bias3 * ANAS0_P.Constant1_Value_hg[i] + ANAS0_P.Bias2_Bias_m[i];
    ...
    for (i_0 = 0; i_0 < 6; i_0++)
    {
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            rtb_LinearQ[rtb_LinearQ_tmp] =
                ANAS0_P.LinearQ_Bias[rtb_LinearQ_tmp] + rtb_Power2;
            k += 6;
        }
    }
    ...
    rtb_Power2 = std::sqrt(
        ((rtb_Switch3[0] * rtb_Switch3[0] + rtb_Switch3[1] * rtb_Switch3[1]) +
         rtb_Switch3[2] * rtb_Switch3[2]) +
    ...
    rtb_ExtractDiagonal[1] =
        (rtb_ExtractDiagonal_tmp_0 - rtb_ExtractDiagonal_tmp) *
    ...
    rtb_ExtractDiagonal[2] =
        (rtb_ExtractDiagonal_tmp_6 + rtb_ExtractDiagonal_tmp_5) *
        ANAS0_P.Gain_Gain_ob;

    // Gain: '<S223>/Gain' incorporates:
    //   Sum: '<S223>/Sum'

    rtb_ExtractDiagonal[3] =
        (rtb_ExtractDiagonal_tmp + rtb_ExtractDiagonal_tmp_0) *
    ...
    rtb_ExtractDiagonal[4] =
        (rtb_ExtractDiagonal_tmp_1 + rtb_ExtractDiagonal_tmp_3) -
        rtb_ExtractDiagonal_tmp_4;
    ...
    rtb_ExtractDiagonal[5] =
        (rtb_ExtractDiagonal_tmp - rtb_ExtractDiagonal_tmp_2) *
        ANAS0_P.Gain_Gain_bt;

    // Gain: '<S224>/Gain' incorporates:
    //   Sum: '<S224>/Sum'

    rtb_ExtractDiagonal[6] =
        (rtb_ExtractDiagonal_tmp_5 - rtb_ExtractDiagonal_tmp_6) *
        ANAS0_P.Gain_Gain_p3;

    // Gain: '<S227>/Gain' incorporates:
    //   Sum: '<S227>/Sum'

    rtb_ExtractDiagonal[7] =
        (rtb_ExtractDiagonal_tmp_2 + rtb_ExtractDiagonal_tmp) *
        ANAS0_P.Gain_Gain_a;
    ...
    for (i_0 = 0; i_0 < 3; i_0++)
    {
        ...
        rtb_VectorConcatenate_o[i_0 + 3] =
            (((rtb_ExtractDiagonal[i + 1] * rtb_Divide5_a +
               rtb_ExtractDiagonal[i] * rtb_Power2) +
              rtb_ExtractDiagonal[i + 2] * rtb_Product1_j3) +
             ANAS0_P.LocalGravity_Value_jy[i_0]) *
                ANAS0_P.AccPropagationFlag_Gain * rtb_Bias3 +
            rtb_Product2_k0;
        rtb_VectorConcatenate_o[i_0] =
            rtb_Product2_k0 * rtb_Bias3 + rtb_Switch2[i_0];
        i += 3;
    }
    ...
    u0 = static_cast<uint8_t>(ANAS0_DW.UnitDelay3_DSTATE_h +
                              ANAS0_P.Bias1_Bias_o);
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        rtb_Selector2[i_0 + 1] =
            ANAS0_U.ANASReference_f.InitialCovariance[k + 61];
        rtb_Selector2[i_0 + 2] =
            ANAS0_U.ANASReference_f.InitialCovariance[k + 62];
        i_0 += 3;
        k += 9;
    }
    ...
    if (ANAS0_DW.UnitDelay3_DSTATE_o > ANAS0_P.Switch_Threshold)
    {
        rtb_Bias3 = static_cast<float>(ANAS0_U.ANASIn_c.GyroTimestamp -
                                       ANAS0_DW.UD_DSTATE_a) *
                    ANAS0_P.Gain1_Gain_h;
    }
    else
    {
    ...
    rtb_ExtractDiagonal[1] =
        ANAS0_P.Gain1_Gain_oh * ANAS0_U.ANASIn_c.GyroMeasure[2];
    ...
    rtb_ExtractDiagonal[5] =
        ANAS0_P.Gain2_Gain_d * ANAS0_U.ANASIn_c.GyroMeasure[0];
    ...
    rtb_ExtractDiagonal[6] =
        ANAS0_P.Gain_Gain_e * ANAS0_U.ANASIn_c.GyroMeasure[1];
    ...
    for (i = 0; i < 9; i++)
    {
        rtb_MatrixConcatenate[i] =
            ANAS0_P.Gain_Gain_eg * rtb_MatrixMultiply2[i];
    }
    ...
    for (i_0 = 0; i_0 < 9; i_0++)
    {
        ...
        rtb_MatrixMultiply2[i_0] =
            rtb_Bias3 * rtb_MatrixMultiply2[i_0] + ANAS0_P.Constant2_Value[i_0];
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        for (k = 0; k < 3; k++)
        {
            ...
            rtb_Sum2[rtb_LinearQ_tmp] =
                ((rtb_S_jt[i_0 + 1] * rtb_Divide1_p + rtb_S_jt[i_0] * rtb_Add) +
                 rtb_S_jt[i_0 + 2] * rtb_Power) +
    ...
    {
        rtb_Switch3[i_0] =
            ((rtb_S[i_0 + 4] * rtb_Divide5_a + rtb_S[i_0] * rtb_Power2) +
             rtb_S[i_0 + 8] * rtb_Product1_j3) +
    ...
    rtb_Bias3 = std::sqrt(
        ((rtb_Switch3[3] * rtb_Switch3[3] + rtb_Switch3[0] * rtb_Switch3[0]) +
         rtb_Switch3[1] * rtb_Switch3[1]) +
        rtb_Switch3[2] * rtb_Switch3[2]);
    ...
    u0 = static_cast<uint8_t>(ANAS0_DW.UnitDelay3_DSTATE_o +
                              ANAS0_P.Bias1_Bias_k);
    ...
    rtb_Divide5_a = std::sqrt(
        (ANAS0_U.ANASIn_c.AccMeasure[0] * ANAS0_U.ANASIn_c.AccMeasure[0] +
         ANAS0_U.ANASIn_c.AccMeasure[1] * ANAS0_U.ANASIn_c.AccMeasure[1]) +
        ANAS0_U.ANASIn_c.AccMeasure[2] * ANAS0_U.ANASIn_c.AccMeasure[2]);
    ...
    rtb_AND_b =
        (ANAS0_P.AccCorrFlag_Value &&
         (ANAS0_DW.RateTransition_i > ANAS0_DW.Memory_PreviousInput_k) &&
         ((ANAS0_P.g02accg02_lowlimit <= rtb_Divide5_a) &&
          (rtb_Divide5_a <= ANAS0_P.g02accg02_uplimit)) &&
    ...
    rtb_AND_i =
        (ANAS0_P.MagCorrFlag_Value &&
         (ANAS0_DW.RateTransition_o > ANAS0_DW.Memory_PreviousInput_kq));

    // Outputs for Enabled SubSystem: '<S9>/Active Correction Step Magnetometer'
    // incorporates:
    ...
    if (rtb_AND_i)
    {
        ...
        rtb_Bias3 = std::sqrt(
            ((rtb_Power2 * rtb_Power2 + rtb_Product1_j3 * rtb_Product1_j3) +
             rtb_Product2_k0 * rtb_Product2_k0) +
            rtb_Product3_jl * rtb_Product3_jl);
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            rtb_Transpose_c[i_0] = (rtb_ExtractDiagonal[i_0 + 3] * rtb_Bias3 +
                                    rtb_ExtractDiagonal[i_0] * rtb_Divide1_p) +
                                   rtb_ExtractDiagonal[i_0 + 6] * rtb_Add;
        }
        ...
        for (k = 0; k < 3; k++)
        {
            ...
            for (i = 0; i < 3; i++)
            {
                rtb_LUFactorization_o1_c[i + i_0] =
                    (rtb_Sum2[i + 3] * rtb_Divide1_p + rtb_Add * rtb_Sum2[i]) +
                    rtb_Sum2[i + 6] * rtb_Power;
            }
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            {
                rtb_LinearQ_tmp = k + i_0;
                rtb_S_jt[rtb_LinearQ_tmp] =
                    ((rtb_LUFactorization_o1_c[k + 1] * rtb_Bias3 +
                      rtb_LUFactorization_o1_c[k] * rtb_Divide1_p) +
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S60>/Matrix
            // 1-Norm2'
            {
            ...
            for (k = 0; k < 3; k++)
            {
                ...
                rtb_BackwardSubstitution_e[3 * k] =
                    ANAS0_DW.IdentityMatrix_j[3 * k + i_0];
                ...
                rtb_BackwardSubstitution_e[3 * k + 1] =
                    ANAS0_DW.IdentityMatrix_j[3 * k + i_0];
                ...
                rtb_BackwardSubstitution_e[3 * k + 2] =
                    ANAS0_DW.IdentityMatrix_j[3 * k + i_0];
            }

            // End of S-Function (sdspperm2): '<S62>/Permute Matrix'

            // S-Function (sdspfbsub2): '<S62>/Forward Substitution'
            // incorporates:
            //   S-Function (sdspfbsub2): '<S62>/Backward Substitution'
            ...
            {
                i_0 = i * 3;
                rtb_BackwardSubstitution_e[i_0 + 1] -=
                    rtb_LUFactorization_o1_c[1] *
            ...
            for (i = 0; i < 3; i++)
            {
                ...
                rtb_BackwardSubstitution_e[i_0 + 1] =
                    (rtb_BackwardSubstitution_e[i_0 + 1] -
                     rtb_Bias3 * rtb_LUFactorization_o1_c[7]) /
                ...
                rtb_BackwardSubstitution_e[i_0] =
                    rtb_Add / rtb_LUFactorization_o1_c[rtb_LinearQ_tmp];
            }
        ...
        if (rtb_Bias3 >= ANAS0_P.NASCondLim_Value_n)
        {
            for (i = 0; i < 9; i++)
            {
                // Outputs for IfAction SubSystem: '<S54>/Correction'
                // incorporates:
        ...
        else
        {
            for (i = 0; i < 9; i++)
            {
                // Outputs for IfAction SubSystem: '<S54>/No correction'
                // incorporates:
            ...
            ANAS0_Nocorrection(rtb_LUFactorization_o1_c,
                               rtb_BackwardSubstitution_e,
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            for (i = 0; i < 3; i++)
            {
                ...
                rtb_MatrixMultiply_i[rtb_LinearQ_tmp] =
                    ANAS0_P.Constant_Value_l[rtb_LinearQ_tmp] -
                    ((rtb_Transpose_g[k + 1] * rtb_Bias3 +
                      rtb_Transpose_g[k] * rtb_Matrix1Norm2_j) +
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            for (i = 0; i < 3; i++)
            {
                rtb_LinearQ_tmp = k + i_0;
                rtb_S_jt[rtb_LinearQ_tmp] =
                    (rtb_BackwardSubstitution_e[i + 3] * rtb_Divide1_p +
                     rtb_Add * rtb_BackwardSubstitution_e[i]) +
                    rtb_BackwardSubstitution_e[i + 6] * rtb_Power;
                rtb_LUFactorization_o1_c[rtb_LinearQ_tmp] =
                    (rtb_MatrixMultiply_i[i + 3] * rtb_Matrix1Norm2_j +
                     rtb_Matrix1Norm1_k * rtb_MatrixMultiply_i[i]) +
        ...
        if ((&ANAS0_M)->Timing.TaskCounters.TID[1] == 0)
        {
            ...
            for (i_0 = 0; i_0 < 3; i_0++)
            {
                ...
                ANAS0_DW.fromGGausstonTTesla[i_0] =
                    ((rtb_Sum2[i_0 + 3] * rtb_Matrix1Norm2_j +
                      rtb_Sum2[i_0] * rtb_Matrix1Norm1_k) +
                     rtb_Sum2[i_0 + 6] * rtb_Bias3) *
                    ANAS0_P.fromGGausstonTTesla_Gain;
            }
        ...
        rtb_Matrix1Norm2_j =
            ANAS0_DW.fromGGausstonTTesla[0] - rtb_Transpose_c[0];
        rtb_Matrix1Norm1_k =
            ANAS0_DW.fromGGausstonTTesla[1] - rtb_Transpose_c[1];
        ...
        for (i = 0; i < 3; i++)
        {
            ...
            rtb_Divide1_p =
                (rtb_BackwardSubstitution_e[i + 3] * rtb_Matrix1Norm1_k +
        ...
        rtb_Bias3 = std::sqrt(((rtb_res_GPS[0] * rtb_res_GPS[0] +
                                rtb_res_GPS[1] * rtb_res_GPS[1]) +
                               rtb_res_GPS[2] * rtb_res_GPS[2]) +
                              rtb_res_GPS[3] * rtb_res_GPS[3]);
        ...
        ANAS0_DW.Merge_l[0] =
            ((rtb_Power2 * rtb_Power - rtb_Product1_j3 * rtb_Add) -
             rtb_Product2_k0 * rtb_Divide1_p) -
            rtb_Product3_jl * rtb_Bias3;
        ...
        ANAS0_DW.Merge_l[1] =
            ((rtb_Power2 * rtb_Add + rtb_Product1_j3 * rtb_Power) +
             rtb_Product2_k0 * rtb_Bias3) -
            rtb_Product3_jl * rtb_Divide1_p;
        ...
        ANAS0_DW.Merge_l[2] =
            ((rtb_Power2 * rtb_Divide1_p - rtb_Product1_j3 * rtb_Bias3) +
             rtb_Product2_k0 * rtb_Power) +
            rtb_Product3_jl * rtb_Add;
        ...
        ANAS0_DW.Merge_l[3] =
            ((rtb_Power2 * rtb_Bias3 + rtb_Product1_j3 * rtb_Divide1_p) -
             rtb_Product2_k0 * rtb_Add) +
            rtb_Product3_jl * rtb_Power;
    }
    else
    {
        // Outputs for Enabled SubSystem: '<S9>/No Correction Step'
        // incorporates:
    ...
    // Outputs for Enabled SubSystem: '<S8>/Active Correction Step
    // Accelerometer' incorporates:
    ...
    if (rtb_AND_b)
    {
        ...
        rtb_Bias3 = std::sqrt(((ANAS0_DW.Merge_l[0] * ANAS0_DW.Merge_l[0] +
                                ANAS0_DW.Merge_l[1] * ANAS0_DW.Merge_l[1]) +
                               ANAS0_DW.Merge_l[2] * ANAS0_DW.Merge_l[2]) +
                              ANAS0_DW.Merge_l[3] * ANAS0_DW.Merge_l[3]);
        ...
        rtb_VectorConcatenate_i[0] =
            ((rtb_Matrix1Norm2_j + rtb_Matrix1Norm1_k) - rtb_Power2) -
            rtb_Product1_j3;
        ...
        rtb_VectorConcatenate_i[1] =
            (rtb_Product3_jl - rtb_Product2_k0) * ANAS0_P.Gain_Gain;
        ...
        rtb_VectorConcatenate_i[2] =
            (rtb_ExtractDiagonal_tmp_2 + rtb_ExtractDiagonal_tmp_1) *
            ANAS0_P.Gain_Gain_o;

        // Gain: '<S35>/Gain' incorporates:
        //   Sum: '<S35>/Sum'

        rtb_VectorConcatenate_i[3] =
            (rtb_Product2_k0 + rtb_Product3_jl) * ANAS0_P.Gain_Gain_i;

        // Sum: '<S38>/Sum' incorporates:
        //   Sum: '<S42>/Sum'

        rtb_Matrix1Norm2_j -= rtb_Matrix1Norm1_k;
        rtb_VectorConcatenate_i[4] =
            (rtb_Matrix1Norm2_j + rtb_Power2) - rtb_Product1_j3;
        ...
        rtb_VectorConcatenate_i[5] =
            (rtb_Product2_k0 - rtb_Matrix1Norm1_k) * ANAS0_P.Gain_Gain_b;

        // Gain: '<S36>/Gain' incorporates:
        //   Sum: '<S36>/Sum'

        rtb_VectorConcatenate_i[6] =
            (rtb_ExtractDiagonal_tmp_1 - rtb_ExtractDiagonal_tmp_2) *
            ANAS0_P.Gain_Gain_h;
        ...
        rtb_VectorConcatenate_i[7] =
            (rtb_Matrix1Norm1_k + rtb_Product2_k0) * ANAS0_P.Gain_Gain_g;

        // Sum: '<S42>/Sum'
        rtb_VectorConcatenate_i[8] =
            (rtb_Matrix1Norm2_j - rtb_Power2) + rtb_Product1_j3;
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            rtb_LUFactorization_o2_m[i_0] =
                (rtb_VectorConcatenate_i[i_0 + 3] * rtb_Matrix1Norm2_j +
                 rtb_VectorConcatenate_i[i_0] * rtb_Matrix1Norm1_k) +
        ...
        // Gain: '<S33>/Gain1'
        rtb_ExtractDiagonal[1] =
            ANAS0_P.Gain1_Gain * rtb_LUFactorization_o2_m[2];
        ...
        // Gain: '<S33>/Gain2'
        rtb_ExtractDiagonal[5] =
            ANAS0_P.Gain2_Gain * rtb_LUFactorization_o2_m[0];

        // Gain: '<S33>/Gain'
        rtb_ExtractDiagonal[6] =
            ANAS0_P.Gain_Gain_j * rtb_LUFactorization_o2_m[1];
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            {
                rtb_Sum2[k + i_0] =
                    (rtb_Transpose_g[i + 3] * rtb_Matrix1Norm2_j +
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            {
                rtb_LinearQ_tmp = k + i_0;
                rtb_VectorConcatenate_i[rtb_LinearQ_tmp] =
                    ((rtb_Sum2[k + 1] * rtb_Bias3 +
                      rtb_Sum2[k] * rtb_Divide1_p) +
                     rtb_Sum2[k + 2] * rtb_Add) +
                    rtb_MatrixMultiply2[rtb_LinearQ_tmp];
                k += 3;
            }
        }
        ...
        LUf_boolfloatint32_t(&rtb_ExtractDiagonal[0],
                             &rtb_LUFactorization_o2_o[0], 3,
                             &rtb_LUFactorization_o3_i);
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S20>/Matrix
            // 1-Norm2'
            {
            ...
            for (k = 0; k < 3; k++)
            {
                ...
                rtb_BackwardSubstitution_e[3 * k] =
                    ANAS0_DW.IdentityMatrix_h[3 * k + i_0];
            ...
            // S-Function (sdspfbsub2): '<S22>/Forward Substitution'
            // incorporates:
            //   S-Function (sdspfbsub2): '<S22>/Backward Substitution'
            //   S-Function (sdsplu2): '<S22>/LU Factorization'
            ...
            for (i = 0; i < 3; i++)
            {
                i_0 = i * 3;
                rtb_BackwardSubstitution_e[i_0 + 1] -=
                    rtb_ExtractDiagonal[1] * rtb_BackwardSubstitution_e[i_0];
                rtb_LinearQ_tmp = 2;
                rtb_Add         = rtb_BackwardSubstitution_e[i_0 + 2];
                for (k = 0; k < 2; k++)
                {
            ...
            for (i = 0; i < 3; i++)
            {
                ...
                rtb_BackwardSubstitution_e[i_0 + 1] =
                    (rtb_BackwardSubstitution_e[i_0 + 1] -
                     rtb_Matrix1Norm2_j * rtb_ExtractDiagonal[7]) /
                    rtb_ExtractDiagonal[4];
                rtb_LinearQ_tmp = 6;
                rtb_Add         = rtb_BackwardSubstitution_e[i_0];
                for (k = 2; k > 0; k--)
                ...
                rtb_BackwardSubstitution_e[i_0] =
                    rtb_Add / rtb_ExtractDiagonal[rtb_LinearQ_tmp];
            }
        ...
        if (rtb_Bias3 >= ANAS0_P.NASCondLim_Value)
        {
            for (i = 0; i < 9; i++)
            {
                // Outputs for IfAction SubSystem: '<S14>/Correction'
                // incorporates:
            ...
            ANAS0_Correction(rtb_BackwardSubstitution_e, rtb_Sum2,
                             rtb_ExtractDiagonal);
        ...
        else
        {
            for (i = 0; i < 9; i++)
            {
                // Outputs for IfAction SubSystem: '<S14>/No correction'
                // incorporates:
            ...
            ANAS0_Nocorrection(rtb_Sum2, rtb_ExtractDiagonal,
                               &ANAS0_P.Nocorrection);
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            for (k = 0; k < 3; k++)
            {
                ...
                rtb_BackwardSubstitution_e[i_0 + 3 * k] =
                    (rtb_ExtractDiagonal[k + 3] * rtb_Divide1_p +
                     rtb_Add * rtb_ExtractDiagonal[k]) +
                ...
                rtb_MatrixMultiply2[rtb_LinearQ_tmp] =
                    ANAS0_P.Constant_Value_b[rtb_LinearQ_tmp] -
                    ((rtb_Transpose_g[3 * k + 1] * rtb_Matrix1Norm2_om +
                      rtb_Transpose_g[3 * k] * rtb_Matrix1Norm1_p) +
        ...
        for (i_0 = 0; i_0 < 3; i_0++)
        {
            ...
            {
                rtb_Sum2[k + i_0] =
                    (rtb_MatrixMultiply2[i + 3] * rtb_Matrix1Norm2_j +
        ...
        for (k = 0; k < 3; k++)
        {
            ...
            for (i = 0; i < 3; i++)
            {
                rtb_LinearQ_tmp = i + i_0;
                rtb_VectorConcatenate_i[rtb_LinearQ_tmp] =
                    (rtb_ExtractDiagonal[i + 3] * rtb_Matrix1Norm2_j +
                     rtb_Matrix1Norm2_om * rtb_ExtractDiagonal[i]) +
                    rtb_ExtractDiagonal[i + 6] * rtb_Matrix1Norm1_p;
                rtb_S_jt[rtb_LinearQ_tmp] =
                    (rtb_MatrixMultiply2[i + 3] * rtb_Power2 +
                     rtb_Matrix1Norm1_k * rtb_MatrixMultiply2[i]) +
                    rtb_MatrixMultiply2[i + 6] * rtb_Product1_j3;
            }
        ...
        rtb_Matrix1Norm2_j =
            ANAS0_U.ANASIn_c.AccMeasure[0] - rtb_LUFactorization_o2_m[0];
        rtb_Matrix1Norm1_k =
            ANAS0_U.ANASIn_c.AccMeasure[1] - rtb_LUFactorization_o2_m[1];
        ...
        for (i = 0; i < 3; i++)
        {
            ...
            rtb_Matrix1Norm1_p =
                (rtb_ExtractDiagonal[i + 3] * rtb_Matrix1Norm1_k +
        ...
        rtb_res_GPS[0] = std::sqrt(
            rtb_Bias3 * rtb_Bias3 * ANAS0_P.Gain_Gain_h5 + ANAS0_P.Bias_Bias);
        ...
        ANAS0_DW.Merge_h[0] = ((ANAS0_DW.Merge_l[0] * rtb_Power -
                                ANAS0_DW.Merge_l[1] * rtb_Divide1_p) -
                               ANAS0_DW.Merge_l[2] * rtb_Power2) -
                              ANAS0_DW.Merge_l[3] * rtb_Bias3;
        ...
        ANAS0_DW.Merge_h[1] = ((ANAS0_DW.Merge_l[0] * rtb_Divide1_p +
                                ANAS0_DW.Merge_l[1] * rtb_Power) +
                               ANAS0_DW.Merge_l[2] * rtb_Bias3) -
        ...
        ANAS0_DW.Merge_h[2] = ((ANAS0_DW.Merge_l[0] * rtb_Power2 -
                                ANAS0_DW.Merge_l[1] * rtb_Bias3) +
                               ANAS0_DW.Merge_l[2] * rtb_Power) +
                              ANAS0_DW.Merge_l[3] * rtb_Divide1_p;
        ...
        ANAS0_DW.Merge_h[3] = ((ANAS0_DW.Merge_l[0] * rtb_Bias3 +
                                ANAS0_DW.Merge_l[1] * rtb_Power2) -
                               ANAS0_DW.Merge_l[2] * rtb_Divide1_p) +
                              ANAS0_DW.Merge_l[3] * rtb_Power;
    }
    else
    {
    ...
    rtb_AND = (ANAS0_P.GPSCorrectionFlag_Value &&
               (ANAS0_DW.RateTransition > ANAS0_DW.Memory_PreviousInput) &&
               (rtb_Divide5_a <= ANAS0_P.GPSAccelerationLimit_const) &&
               ANAS0_U.ANASIn_c.GPSFix);

    // Outputs for Enabled SubSystem: '<S97>/Active Correction Step GPS'
    // incorporates:
    ...
    if (rtb_AND)
    {
        ...
        rtb_Add = (ANAS0_P.GPS1a1_Gain * rtb_VectorConcatenate_o[0] +
                   ANAS0_P.GPSlat0_Bias) *
                  ANAS0_P.Gain1_Gain_ke;
        ...
        rtb_Transpose1_j[1] =
            rtb_Divide1_p / (rtb_Add * rtb_Add) * ANAS0_P.GPSb1_Gain;
        rtb_Transpose1_j[2] = ANAS0_P.Constant1_Value_i;
        rtb_Transpose1_j[3] =
            1.0F / (ANAS0_P.GPSb_Gain * rtb_Add) * ANAS0_P.Constant2_Value_g;
        ...
        for (i_0 = 0; i_0 < 4; i_0++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 4; rtb_LinearQ_tmp++)
            {
                ...
                {
                    rtb_Power2 +=
                        rtb_Transpose1[rtb_S_tmp_0 + i_0] * rtb_S_tmp[i_1 + i];
                    rtb_S_tmp_0 += 4;
                }
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S213>/Matrix
            // 1-Norm2'
            {
            ...
            for (k = 0; k < 4; k++)
            {
                ...
                rtb_BackwardSubstitution[i + 1] =
                    ANAS0_DW.IdentityMatrix[i + i_0];
                ...
                rtb_BackwardSubstitution[i + 3] =
                    ANAS0_DW.IdentityMatrix[i + i_0];
            }

            // End of S-Function (sdspperm2): '<S215>/Permute Matrix'

            // S-Function (sdspfbsub2): '<S215>/Forward Substitution'
            // incorporates:
            //   S-Function (sdspfbsub2): '<S215>/Backward Substitution'
            ...
            {
                i_0 = i << 2;
                rtb_BackwardSubstitution[i_0 + 1] -=
                    rtb_LUFactorization_o1[1] * rtb_BackwardSubstitution[i_0];
                rtb_LinearQ_tmp = 2;
            ...
            for (i = 0; i < 4; i++)
            {
                ...
                rtb_BackwardSubstitution[i_0 + 2] =
                    (rtb_BackwardSubstitution[i_0 + 2] -
                ...
                rtb_BackwardSubstitution[i_0 + 1] =
                    rtb_Add / rtb_LUFactorization_o1[rtb_LinearQ_tmp];
                rtb_LinearQ_tmp = 12;
        ...
        {
            // Outputs for IfAction SubSystem: '<S207>/No correction'
            // incorporates:
        ...
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            ...
            {
                rtb_S_tmp_0 = k + i_0;
                rtb_Transpose_e[rtb_S_tmp_0] =
                    ANAS0_P.Constant_Value_a[rtb_S_tmp_0] -
                    (((rtb_Transpose1[i + 1] * rtb_Matrix1Norm2 +
                       rtb_Transpose1[i] * rtb_Matrix1Norm1) +
                      rtb_Transpose1[i + 2] * rtb_Matrix1Norm2_om) +
        ...
        for (i_0 = 0; i_0 < 4; i_0++)
        {
            ...
            for (i = 0; i < 6; i++)
            {
                rtb_Transpose1[k + i_0] =
                    ((rtb_Merge_gj[i + 6] * rtb_Matrix1Norm2 +
                      rtb_Matrix1Norm1 * rtb_Merge_gj[i]) +
                     rtb_Merge_gj[i + 12] * rtb_Matrix1Norm2_om) +
                    rtb_Merge_gj[i + 18] * rtb_Matrix1Norm1_p;
                k += 4;
            }
        }
        ...
        for (i = 0; i < 6; i++)
        {
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                ...
                {
                    rtb_Matrix1Norm1 +=
                        rtb_Transpose_e[rtb_S_tmp_0 + rtb_LinearQ_tmp] *
                ...
                rtb_Merge_p[rtb_S_tmp_0] =
                    ((rtb_Transpose1[k + 1] *
                          rtb_Merge_gj[rtb_LinearQ_tmp + 6] +
                      rtb_Transpose1[k] * rtb_Merge_gj[rtb_LinearQ_tmp]) +
                     rtb_Transpose1[k + 2] *
                         rtb_Merge_gj[rtb_LinearQ_tmp + 12]) +
                    rtb_Transpose1[k + 3] * rtb_Merge_gj[rtb_LinearQ_tmp + 18];
            }
        ...
        rtb_Matrix1Norm1_k =
            ANAS0_U.ANASIn_c.GPSMeasure[1] -
            (1.0F / std::cos(ANAS0_P.Gain1_Gain_af * rtb_Add) *
                 (ANAS0_P.GPS1b_Gain * rtb_VectorConcatenate_o[1]) +
             ANAS0_P.GPSlon0_Bias);
        rtb_Add = ANAS0_U.ANASIn_c.GPSMeasure[2] - rtb_VectorConcatenate_o[3];
        rtb_Matrix1Norm2 =
            ANAS0_U.ANASIn_c.GPSMeasure[3] - rtb_VectorConcatenate_o[4];
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            ...
            rtb_VectorConcatenate_o[i_0] +=
                ((rtb_Merge_gj[i_0 + 6] * rtb_Matrix1Norm1_k +
                  rtb_Merge_gj[i_0] * rtb_Matrix1Norm2_j) +
                 rtb_Merge_gj[i_0 + 12] * rtb_Add) +
                rtb_Merge_gj[i_0 + 18] * rtb_Matrix1Norm2;
        }
    }
    ...
    // Outputs for Enabled SubSystem: '<S96>/Active Correction Step Pitot Static
    // & Differential' incorporates:
    //   EnablePort: '<S100>/Enable'

    // Outputs for Enabled SubSystem: '<S96>/Active Correction Step Main Static
    // & Pitot' incorporates:
    ...
    rtb_Matrix1Norm2_j =
        std::sqrt((rtb_VectorConcatenate_o[3] * rtb_VectorConcatenate_o[3] +
                   rtb_VectorConcatenate_o[4] * rtb_VectorConcatenate_o[4]) +
                  rtb_VectorConcatenate_o[5] * rtb_VectorConcatenate_o[5]);

    // End of Outputs for SubSystem: '<S96>/Active Correction Step Main Static &
    // Pitot' End of Outputs for SubSystem: '<S96>/Active Correction Step Pitot
    // Static & Differential'
    ...
    rtb_LUFactorization_o3 =
        ((rtb_Matrix1Norm2_j /
              std::sqrt(1.0F / ANAS0_P.AirR_Value_i / ANAS0_P.IsaGamma_Value_b /
                        (ANAS0_P.Baroa_Value_f * rtb_VectorConcatenate_o[2] +
                         ANAS0_U.ANASReference_f.GroundTemperature) *
                        rtb_Matrix1Norm2) >=
          ANAS0_P.PitotMinMach_const) &&
    ...
    rtb_LUFactorization_o3_j =
        ((!ANAS0_P.StaticPitotFlag1_Value) && rtb_do_barometer_correcion);
    ...
    rtb_variometer =
        (ANAS0_P.VaroFlag_Value && rtb_LUFactorization_o3_j &&
         (ANAS0_DW.RateTransition2 > ANAS0_DW.Memory1_PreviousInput));

    // Outputs for Enabled SubSystem: '<S96>/Active Correction Step Baro &
    // Variometer ' incorporates:
    ...
    if (rtb_variometer)
    {
        ...
        rtb_Power =
            std::pow(ANAS0_P.Constant2_Value_l - 1.0F / rtb_Bias3 * rtb_Add,
                     1.0F / ANAS0_P.Baroa_Value * ANAS0_P.Constant1_Value_f *
                         ANAS0_P.BarogR_Value) *
            (1.0F / rtb_Bias3) * ANAS0_P.BarogR_Value *
        ...
        rtb_Transpose_k[2] =
            (std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                       ANAS0_P.Gain1_Gain_a * rtb_VectorConcatenate_o[2] *
                           ANAS0_P.RAir1_Value) /
                          ANAS0_U.ANASReference_f.GroundTemperature,
                      ANAS0_P.LocalGravity_Value_j /
        ...
        for (k = 0; k < 2; k++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                rtb_MatrixConcatenate[rtb_LinearQ_tmp + i_0] =
                    rtb_Transpose1_j[i + k];
                i += 2;
            }
        ...
        rtb_res_GPS[0] =
            ANAS0_P.BaroVaroSigma_Value[0] * ANAS0_P.BaroVaroSigma_Value[0];
        rtb_res_GPS[1] =
            ANAS0_P.BaroVaroSigma_Value[1] * ANAS0_P.BaroVaroSigma_Value[1];
        rtb_res_GPS[2] =
            ANAS0_P.BaroVaroSigma_Value[2] * ANAS0_P.BaroVaroSigma_Value[2];
        rtb_res_GPS[3] =
            ANAS0_P.BaroVaroSigma_Value[3] * ANAS0_P.BaroVaroSigma_Value[3];
        ...
        for (i_0 = 0; i_0 < 2; i_0++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 2; rtb_LinearQ_tmp++)
            {
                ...
                for (i_1 = 0; i_1 < 6; i_1++)
                {
                    rtb_Power2 += rtb_Transpose1_j[rtb_S_tmp_0 + i_0] *
                                  rtb_S_ce_tmp[i_1 + i];
                    rtb_S_tmp_0 += 2;
                }

                rtb_S_tmp_0 = k + i_0;
                rtb_LUFactorization_o2[rtb_S_tmp_0] =
                    rtb_res_GPS[rtb_S_tmp_0] + rtb_Power2;
                k += 2;
                i += 6;
            }
        }
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S113>/Matrix
            // 1-Norm2'
            {
            ...
            k = static_cast<int32_t>(std::floor(rtb_LUFactorization_o2_l[0])) -
                1;
            i_0 = k;
            if (k < 0)
                i_0 = 0;
            ...
            i = static_cast<int32_t>(std::floor(rtb_LUFactorization_o2_l[1])) -
                1;
            i_0 = i;
            if (i < 0)
                i_0 = 0;
            ...
            rtb_BackwardSubstitution_f1[2] =
                ANAS0_DW.IdentityMatrix_eg[i_0 + 2];
            i_0 = i;
            if (i < 0)
                i_0 = 0;
            else if (i >= 2)
            ...
            rtb_BackwardSubstitution_f1[3] =
                ANAS0_DW.IdentityMatrix_eg[i_0 + 2];

            // End of S-Function (sdspperm2): '<S115>/Permute Matrix'

            // S-Function (sdspfbsub2): '<S115>/Forward Substitution'
            // incorporates:
            //   S-Function (sdspfbsub2): '<S115>/Backward Substitution'
            //   S-Function (sdsplu2): '<S115>/LU Factorization'

            rtb_BackwardSubstitution_f1[1] -=
                rtb_BackwardSubstitution_f1[0] * rtb_LUFactorization_o1_if[1];
            rtb_BackwardSubstitution_f1[3] -=
                rtb_LUFactorization_o1_if[1] * rtb_BackwardSubstitution_f1[2];
            ...
            rtb_BackwardSubstitution_f1[0] =
                (rtb_BackwardSubstitution_f1[0] -
                 rtb_BackwardSubstitution_f1[1] *
                     rtb_LUFactorization_o1_if[2]) /
        ...
        {
            // Outputs for IfAction SubSystem: '<S107>/No correction'
            // incorporates:
        ...
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                rtb_S_tmp_0 = k + i_0;
                rtb_Transpose_e[rtb_S_tmp_0] =
                    ANAS0_P.Constant_Value_n[rtb_S_tmp_0] -
                    (rtb_Transpose1_j[i + 1] * rtb_Matrix1Norm2_m +
                     rtb_Transpose1_j[i] * rtb_Matrix1Norm1_a);
                k += 6;
                i += 2;
            }
        }
        ...
        for (i_0 = 0; i_0 < 2; i_0++)
        {
            ...
            for (i = 0; i < 6; i++)
            {
                rtb_Transpose1_j[k + i_0] =
                    rtb_MatrixConcatenate[i + 6] * rtb_Divide5_a +
        ...
        for (i = 0; i < 6; i++)
        {
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                ...
                rtb_Transpose_aq[rtb_S_tmp_0] = rtb_Matrix1Norm1;
                rtb_Merge_p[rtb_S_tmp_0] =
                    rtb_Transpose1_j[k + 1] *
                        rtb_MatrixConcatenate[rtb_LinearQ_tmp + 6] +
                    rtb_Transpose1_j[k] *
        ...
        rtb_Matrix1Norm2_m =
            ANAS0_U.ANASIn_c.BaroMeasure -
            std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                      ANAS0_P.Gain_Gain_c * rtb_VectorConcatenate_o[2] *
                          ANAS0_P.RAir1_Value_c) /
                         ANAS0_U.ANASReference_f.GroundTemperature,
                     ANAS0_P.LocalGravity_Value_h /
                         (ANAS0_P.RAir1_Value_c * ANAS0_P.RAir_Value_o)) *
                ANAS0_U.ANASReference_f.GroundPressure;
        rtb_Matrix1Norm1_a =
            ANAS0_P.DiscreteFilter_NumCoef[1] * ANAS0_DW.DiscreteFilter_states -
            std::pow(ANAS0_P.Constant2_Value_lk - 1.0F / rtb_Bias3 * rtb_Add,
                     1.0F / ANAS0_P.Baroa_Value_g * ANAS0_P.Constant1_Value_p *
                         ANAS0_P.BarogR_Value_i) *
                (1.0F / rtb_Bias3) * ANAS0_P.BarogR_Value_i *
                ANAS0_U.ANASReference_f.GroundPressure *
                rtb_VectorConcatenate_o[5];
        for (i = 0; i < 6; i++)
        {
            ...
            ANAS0_DW.Merge[i] =
                (rtb_MatrixConcatenate[i + 6] * rtb_Matrix1Norm1_a +
        ...
        ANAS0_DW.DiscreteFilter_states =
            ((ANAS0_U.ANASIn_c.BaroMeasure - ANAS0_DW.UD_DSTATE_h) *
                 ANAS0_P.frequencyPrediction_Value -
             ANAS0_P.DiscreteFilter_DenCoef[1] *
                 ANAS0_DW.DiscreteFilter_states) /
    ...
    // End of Outputs for SubSystem: '<S96>/Active Correction Step Baro &
    // Variometer '
    ...
    rtb_main_s_w_pitot_d =
        ((!ANAS0_P.StaticPitotFlag_Value) && rtb_LUFactorization_o3);
    ...
    if (rtb_main_s_w_pitot_d)
    {
        ...
        rtb_Power =
            std::pow(ANAS0_P.Constant2_Value_n - 1.0F / rtb_Bias3 * rtb_Add,
        ...
        rtb_Divide1_p = 1.0F / ANAS0_P.Constant10_Value /
                            ANAS0_P.Constant6_Value_f / rtb_Bias3 *
                            rtb_Matrix1Norm2 * ANAS0_P.Constant11_Value *
                            ANAS0_P.Gain2_Gain_h +
                        ANAS0_P.Bias2_Bias;
        ...
        rtb_Power2 =
            std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                      ANAS0_P.Gain1_Gain_b * rtb_VectorConcatenate_o[2] *
                          ANAS0_P.RAir1_Value_cc) /
                         ANAS0_U.ANASReference_f.GroundTemperature,
                     ANAS0_P.LocalGravity_Value_p /
                         (ANAS0_P.RAir1_Value_cc * ANAS0_P.RAir_Value_p)) *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        rtb_MatrixMultiply_f[2] =
            (std::pow(rtb_Divide1_p, rtb_Divide5_a) + ANAS0_P.Bias4_Bias) *
                rtb_Power -
            std::pow(rtb_Divide1_p, rtb_Divide5_a + ANAS0_P.Bias2_Bias_l) *
                rtb_Power2 * rtb_Matrix1Norm2 * ANAS0_P.Constant8_Value /
                (rtb_Bias3 * rtb_Bias3) * ANAS0_P.Baro05R_Gain;
        ...
        rtb_Bias3 =
            std::pow(rtb_Divide1_p, rtb_Divide5_a + ANAS0_P.Bias3_Bias) *
        ...
        rtb_res_GPS[0] =
            ANAS0_P.PitotDBaroSigma_Value[0] * ANAS0_P.PitotDBaroSigma_Value[0];
        rtb_res_GPS[1] =
            ANAS0_P.PitotDBaroSigma_Value[1] * ANAS0_P.PitotDBaroSigma_Value[1];
        rtb_res_GPS[2] =
            ANAS0_P.PitotDBaroSigma_Value[2] * ANAS0_P.PitotDBaroSigma_Value[2];
        rtb_res_GPS[3] =
            ANAS0_P.PitotDBaroSigma_Value[3] * ANAS0_P.PitotDBaroSigma_Value[3];
        ...
        for (i_0 = 0; i_0 < 2; i_0++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 2; rtb_LinearQ_tmp++)
            {
                ...
                rtb_S_tmp_0 = k + i_0;
                rtb_LUFactorization_o1_if[rtb_S_tmp_0] =
                    rtb_res_GPS[rtb_S_tmp_0] + rtb_Power2;
                k += 2;
                i += 6;
            }
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S134>/Matrix
            // 1-Norm2'
            {
            ...
            k = static_cast<int32_t>(std::floor(rtb_LUFactorization_o2_b[0])) -
                1;
            i_0 = k;
            if (k < 0)
                i_0 = 0;
            ...
            i = static_cast<int32_t>(std::floor(rtb_LUFactorization_o2_b[1])) -
                1;
            i_0 = i;
            if (i < 0)
                i_0 = 0;
            ...
            // S-Function (sdspfbsub2): '<S136>/Forward Substitution'
            // incorporates:
            //   S-Function (sdspfbsub2): '<S136>/Backward Substitution'
            //   S-Function (sdsplu2): '<S136>/LU Factorization'

            rtb_BackwardSubstitution_n[1] -=
                rtb_BackwardSubstitution_n[0] * rtb_LUFactorization_o1_iq[1];
            rtb_BackwardSubstitution_n[3] -=
                rtb_LUFactorization_o1_iq[1] * rtb_BackwardSubstitution_n[2];
        ...
        {
            // Outputs for IfAction SubSystem: '<S125>/No correction'
            // incorporates:
        ...
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                rtb_S_tmp_0 = k + i_0;
                rtb_Transpose_e[rtb_S_tmp_0] =
                    ANAS0_P.Constant_Value_k5[rtb_S_tmp_0] -
                    (rtb_Transpose1_j[i + 1] * rtb_Matrix1Norm2_m +
                     rtb_Transpose1_j[i] * rtb_Matrix1Norm1_a);
                k += 6;
                i += 2;
        ...
        rtb_Bias3 =
            std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                      ANAS0_P.Gain_Gain_l * rtb_VectorConcatenate_o[2] *
                         ...
                         ANAS0_U.ANASReference_f.GroundTemperature,
                     ANAS0_P.LocalGravity_Value_e /
                         (ANAS0_P.RAir1_Value_m * ANAS0_P.RAir_Value_a)) *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        rtb_Matrix1Norm2_dg =
            ANAS0_U.ANASIn_c.PitotMeasure[0] -
            (std::pow(
                 1.0F / ANAS0_P.AirR_Value / ANAS0_P.IsaGamma_Value_i /
                         (ANAS0_P.Baroa_Value_a * rtb_VectorConcatenate_o[2] +
                          ANAS0_U.ANASReference_f.GroundTemperature) *
                         rtb_Matrix1Norm2 * ANAS0_P.IsaGamma1_Value *
                         ANAS0_P.Gain2_Gain_k +
                     ANAS0_P.Bias2_Bias_b,
                 1.0F / (ANAS0_P.IsaGamma_Value_iz + ANAS0_P.Bias_Bias_p) *
                     ANAS0_P.IsaGamma_Value_iz) -
             ANAS0_P.Constant_Value_pb) *
                rtb_Bias3;
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            ANAS0_DW.Merge[i] =
                (rtb_MatrixConcatenate[i + 6] * rtb_Matrix1Norm1_ax +
    ...
    rtb_LUFactorization_o3_i =
        (rtb_LUFactorization_o3 && ANAS0_P.StaticPitotFlag_Value);
    ...
    if (rtb_LUFactorization_o3_i)
    {
        ...
        rtb_Divide5_a =
            std::pow(ANAS0_P.Constant2_Value_d - 1.0F / rtb_Add * rtb_Bias3,
                     1.0F / ANAS0_P.Constant8_Value_c *
                         ANAS0_P.Constant1_Value_n * rtb_Divide1_p) *
            (1.0F / rtb_Add) * rtb_Divide1_p *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        rtb_Power2 = 1.0F / ANAS0_P.Constant10_Value_i /
                         ANAS0_P.Constant6_Value_j / rtb_Add *
                         rtb_Matrix1Norm2 * ANAS0_P.Constant11_Value_k *
                         ANAS0_P.Gain2_Gain_n +
                     ANAS0_P.Bias2_Bias_f;
        ...
        rtb_Power =
            std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                      ANAS0_P.Gain1_Gain_n * rtb_VectorConcatenate_o[2] *
                         ...
                         ANAS0_U.ANASReference_f.GroundTemperature,
                     ANAS0_P.LocalGravity_Value_o /
                         (ANAS0_P.RAir1_Value_d * ANAS0_P.RAir_Value_k)) *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        rtb_MatrixMultiply_f[2] =
            (std::pow(rtb_Power2, rtb_Bias3) + ANAS0_P.Bias4_Bias_f) *
                rtb_Divide5_a -
            std::pow(rtb_Power2, rtb_Bias3 + ANAS0_P.Bias2_Bias_j) * rtb_Power *
                rtb_Matrix1Norm2 * ANAS0_P.Constant8_Value_c /
                (rtb_Add * rtb_Add) * ANAS0_P.Gain_Gain_c1;
        ...
        rtb_LUFactorization_o1_iq[0] =
            ANAS0_P.PitotDSSigma_Value[0] * ANAS0_P.PitotDSSigma_Value[0];
        rtb_LUFactorization_o1_iq[1] =
            ANAS0_P.PitotDSSigma_Value[1] * ANAS0_P.PitotDSSigma_Value[1];
        rtb_LUFactorization_o1_iq[2] =
            ANAS0_P.PitotDSSigma_Value[2] * ANAS0_P.PitotDSSigma_Value[2];
        rtb_LUFactorization_o1_iq[3] =
            ANAS0_P.PitotDSSigma_Value[3] * ANAS0_P.PitotDSSigma_Value[3];
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S154>/Matrix
            // 1-Norm2'
            {
                const float* uPtr{&rtb_BackwardSubstitution_n[0]};
            ...
            k = static_cast<int32_t>(std::floor(rtb_LUFactorization_o2_n[0])) -
                1;
            i_0 = k;
            if (k < 0)
                i_0 = 0;
            ...
            i = static_cast<int32_t>(std::floor(rtb_LUFactorization_o2_n[1])) -
                1;
            i_0 = i;
            if (i < 0)
                i_0 = 0;
            ...
            // S-Function (sdspfbsub2): '<S156>/Forward Substitution'
            // incorporates:
            //   S-Function (sdspfbsub2): '<S156>/Backward Substitution'
            //   S-Function (sdsplu2): '<S156>/LU Factorization'

            rtb_BackwardSubstitution_j[1] -=
                rtb_BackwardSubstitution_j[0] * rtb_LUFactorization_o1_l[1];
            rtb_BackwardSubstitution_j[3] -=
                rtb_LUFactorization_o1_l[1] * rtb_BackwardSubstitution_j[2];
        ...
        {
            // Outputs for IfAction SubSystem: '<S145>/No correction'
            // incorporates:
        ...
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                rtb_S_tmp_0 = k + i_0;
                rtb_Transpose_e[rtb_S_tmp_0] =
                    ANAS0_P.Constant_Value_i[rtb_S_tmp_0] -
                    (rtb_Transpose1_j[i + 1] * rtb_Matrix1Norm2_m +
                     rtb_Transpose1_j[i] * rtb_Matrix1Norm1_a);
                k += 6;
                i += 2;
        ...
        for (i_0 = 0; i_0 < 2; i_0++)
        {
            ...
            {
                rtb_Transpose1_j[k + i_0] =
                    rtb_MatrixConcatenate[i + 6] * rtb_Matrix1Norm2_dg +
                    rtb_Matrix1Norm2_c * rtb_MatrixConcatenate[i];
                k += 2;
            }
        }
        ...
        rtb_Bias3 =
            std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                      ANAS0_P.Gain_Gain_f * rtb_VectorConcatenate_o[2] *
                         ...
                         ANAS0_U.ANASReference_f.GroundTemperature,
                     ANAS0_P.LocalGravity_Value_d /
                         (ANAS0_P.RAir1_Value_b * ANAS0_P.RAir_Value_j)) *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        rtb_Matrix1Norm2_dg =
            ANAS0_U.ANASIn_c.PitotMeasure[0] -
            (std::pow(
                 1.0F / ANAS0_P.AirR_Value_m / ANAS0_P.IsaGamma_Value_m /
                         (ANAS0_P.Baroa_Value_p * rtb_VectorConcatenate_o[2] +
                          ANAS0_U.ANASReference_f.GroundTemperature) *
                         rtb_Matrix1Norm2 * ANAS0_P.IsaGamma1_Value_e *
                         ANAS0_P.Gain2_Gain_e +
                     ANAS0_P.Bias2_Bias_lw,
                 1.0F / (ANAS0_P.IsaGamma_Value_j + ANAS0_P.Bias_Bias_h) *
                     ANAS0_P.IsaGamma_Value_j) -
             ANAS0_P.Constant_Value_nu) *
                rtb_Bias3;
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            ANAS0_DW.Merge[i] =
                (rtb_MatrixConcatenate[i + 6] * rtb_Matrix1Norm2_c +
                 rtb_MatrixConcatenate[i] * rtb_Matrix1Norm2_dg) +
                rtb_VectorConcatenate_o[i];
        }
    }

    // End of Outputs for SubSystem: '<S96>/Active Correction Step Pitot Static
    // & Differential'
    ...
    rtb_LUFactorization_o3 =
        (rtb_LUFactorization_o3_j && (!ANAS0_P.VaroFlag_Value));

    // Outputs for Enabled SubSystem: '<S96>/Active Correction Step Static Main'
    // incorporates:
    ...
    if (rtb_LUFactorization_o3)
    {
        ...
        rtb_MatrixMultiply_f[2] =
            std::pow(ANAS0_P.Constant2_Value_l1 - 1.0F / rtb_Add * rtb_Bias3,
                     1.0F / ANAS0_P.Baroa_Value_h * ANAS0_P.Constant1_Value_l *
                         ANAS0_P.BarogR_Value_k) *
            (1.0F / rtb_Add) * ANAS0_P.BarogR_Value_k *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        for (i_0 = 0; i_0 < 6; i_0++)
        {
            ...
            {
                rtb_Matrix1Norm2_c +=
                    rtb_LinearQ[k + i_0] * rtb_MatrixMultiply_f[i];
                k += 6;
            }
            ...
            rtb_Matrix1Norm2_dg +=
                rtb_MatrixMultiply_f[i_0] * rtb_Matrix1Norm2_c;
        }
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S170>/Matrix
            // 1-Norm2'
            {
        ...
        if (rtb_Add >= ANAS0_P.NASCondLim_Value_i1)
        {
            ...
            ANAS0_Correction_m(rtb_Matrix1Norm2_dg, rtb_Transpose_k,
                               rtb_Switch2, &rtb_Matrix1Norm2_c);

            // End of Outputs for SubSystem: '<S165>/Correction'
        }
        else
        {
            // Outputs for IfAction SubSystem: '<S165>/No correction'
            // incorporates:
            //   ActionPort: '<S169>/Action Port'

            ANAS0_Nocorrection_d(rtb_Matrix1Norm2_dg, rtb_Transpose_k,
                                 rtb_Switch2, &rtb_Matrix1Norm2_c,
                                 &ANAS0_P.Nocorrection_d);
        ...
        for (k = 0; k < 6; k++)
        {
            for (i = 0; i < 6; i++)
            {
                rtb_S_tmp_0 = i + i_0;
                rtb_Transpose_e[rtb_S_tmp_0] =
                    ANAS0_P.Constant_Value_px[rtb_S_tmp_0] -
        ...
        for (k = 0; k < 6; k++)
        {
            ...
            for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
            {
                ...
                rtb_Merge_p[rtb_LinearQ_tmp + i_0] =
                    rtb_Divide1_p * rtb_Switch2[k] *
        ...
        rtb_Add =
            ANAS0_U.ANASIn_c.BaroMeasure -
            std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                      ANAS0_P.Gain_Gain_e5 * rtb_VectorConcatenate_o[2] *
                          ANAS0_P.RAir1_Value_ba) /
                         ANAS0_U.ANASReference_f.GroundTemperature,
                     ANAS0_P.LocalGravity_Value_dq /
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            ANAS0_DW.Merge[i] =
                rtb_Switch2[i] * rtb_Add + rtb_VectorConcatenate_o[i];
        }
    }
    ...
    rtb_do_barometer_correcion =
        (rtb_do_barometer_correcion && ANAS0_P.StaticPitotFlag1_Value);

    // Outputs for Enabled SubSystem: '<S96>/Active Correction Step Static
    // Pitot' incorporates:
    ...
    if (rtb_do_barometer_correcion)
    {
        ...
        rtb_MatrixMultiply_f[2] =
            std::pow(ANAS0_P.Constant2_Value_o - 1.0F / rtb_Add * rtb_Bias3,
                     1.0F / ANAS0_P.Baroa_Value_n * ANAS0_P.Constant1_Value_c *
                         ANAS0_P.BarogR_Value_h) *
            (1.0F / rtb_Add) * ANAS0_P.BarogR_Value_h *
            ANAS0_U.ANASReference_f.GroundPressure;
        ...
        else
        {
            ...
            // DSP System Toolbox Matrix 1-Norm (sdspm1norm2) - '<S183>/Matrix
            // 1-Norm2'
            {
        ...
        {
            // Outputs for IfAction SubSystem: '<S178>/No correction'
            // incorporates:
            //   ActionPort: '<S182>/Action Port'

            ANAS0_Nocorrection_d(rtb_Matrix1Norm2_c, rtb_Transpose_k,
                                 rtb_Switch2, &rtb_Matrix1Norm2_k,
                                 &ANAS0_P.Nocorrection_h);
        ...
        for (k = 0; k < 6; k++)
        {
            for (i = 0; i < 6; i++)
            {
                rtb_S_tmp_0 = i + i_0;
                rtb_Transpose_e[rtb_S_tmp_0] =
                    ANAS0_P.Constant_Value_o[rtb_S_tmp_0] -
                    rtb_Switch2[i] * rtb_MatrixMultiply_f[k];
            }
        ...
        rtb_Add = ANAS0_U.ANASIn_c.PitotMeasure[1] -
                  std::pow((ANAS0_U.ANASReference_f.GroundTemperature -
                            ANAS0_P.Gain_Gain_n * rtb_VectorConcatenate_o[2] *
                                ANAS0_P.RAir1_Value_g) /
                               ANAS0_U.ANASReference_f.GroundTemperature,
                           ANAS0_P.LocalGravity_Value_g /
    ...
    rtb_LUFactorization_o3_j =
        (rtb_LUFactorization_o3_f_tmp_3 && rtb_LUFactorization_o3_f_tmp &&
    ...
    if (rtb_LUFactorization_o3_i && rtb_LUFactorization_o3_f_tmp && tmp &&
        ...
        rtb_LUFactorization_o3_f_tmp_2)
    {
        // Outputs for IfAction SubSystem: '<S103>/If Action Subsystem4'
        // incorporates:
        ...
        // End of Outputs for SubSystem: '<S103>/If Action Subsystem4'
             ...
             rtb_LUFactorization_o3_f_tmp_2)
    {
        // Outputs for IfAction SubSystem: '<S103>/If Action Subsystem1'
        // incorporates:
    ...
    {
        // Outputs for IfAction SubSystem: '<S103>/If Action Subsystem2'
        // incorporates:
    ...
    else if (rtb_do_barometer_correcion && rtb_LUFactorization_o3_f_tmp_3 &&
             tmp && rtb_LUFactorization_o3_f_tmp &&
             rtb_LUFactorization_o3_f_tmp_1 && rtb_LUFactorization_o3_f_tmp_2)
    {
        // Outputs for IfAction SubSystem: '<S103>/If Action Subsystem6'
        // incorporates:
    ...
    {
        tmp = (rtb_LUFactorization_o3_f_tmp && rtb_LUFactorization_o3_f_tmp_3 &&
               tmp && rtb_LUFactorization_o3_f_tmp_0);
        if (tmp && rtb_LUFactorization_o3 && rtb_LUFactorization_o3_f_tmp_2)
        {
            // Outputs for IfAction SubSystem: '<S103>/If Action Subsystem3'
            // incorporates:
        ...
        {
            // Outputs for IfAction SubSystem: '<S103>/If Action Subsystem5'
            // incorporates:
    ...
    std::memcpy(&rtb_Assignment1[0], &ANAS0_P.Zero_Value[0],
                81U * sizeof(float));
    i_0 = 0;
    k   = 0;
    for (i = 0; i < 6; i++)
    {
        for (rtb_LinearQ_tmp = 0; rtb_LinearQ_tmp < 6; rtb_LinearQ_tmp++)
        {
            rtb_Assignment1[rtb_LinearQ_tmp + i_0] =
                ANAS0_DW.Merge1[rtb_LinearQ_tmp + k];
        }
    ...
    // BusCreator generated from: '<S6>/NASDAQ Initial State_BusCreator'
    // incorporates:
    //   Merge: '<S96>/Merge1'
    //   Outport: '<Root>/NASDAQ Initial State'

    std::memcpy(&ANAS0_Y.NASDAQInitialState.LinearCovariance[0],
                &ANAS0_DW.Merge1[0], 36U * sizeof(float));
    ...
    std::memcpy(&ANAS0_DW.UnitDelay_DSTATE[0], &ANAS0_DW.Merge1[0],
                36U * sizeof(float));
    ...
    std::memcpy(&ANAS0_DW.UnitDelay1_DSTATE[0], &rtb_Selector[0],
                36U * sizeof(float));
    for (i = 0; i < 9; i++)
    {
...
{
    {
        ...
        // SystemInitialize for Atomic SubSystem: '<S1>/Linear States
        // Prediction' InitializeConditions for UnitDelay: '<S219>/UD'
        //
        //  Block description for '<S219>/UD':
        //
        //   Store in Global RAM
        ...
        // End of SystemInitialize for SubSystem: '<S1>/Linear States
        // Prediction'

        // SystemInitialize for Atomic SubSystem: '<S1>/Angular States
        // Prediction' InitializeConditions for UnitDelay: '<S89>/UD'
        //
        //  Block description for '<S89>/UD':
        //
        //   Store in Global RAM
        ...
        // End of SystemInitialize for SubSystem: '<S1>/Angular States
        // Prediction'

        // SystemInitialize for Atomic SubSystem: '<S1>/Angular States
        // Corrections' InitializeConditions for Memory: '<S11>/Memory'
        ...
        // SystemInitialize for Enabled SubSystem: '<S8>/Active Correction Step
        // Accelerometer' SystemInitialize for Enabled SubSystem: '<S9>/Active
        // Correction Step Magnetometer'
        for (i = 0; i < 9; i++)
        {
            ...
            ANAS0_DW.IdentityMatrix_j[i] =
                ANAS0_P.IdentityMatrix_IDMatrixData_a[i];

            // Start for IdentityMatrix: '<S22>/Identity Matrix' incorporates:
            //   UnitDelay: '<S7>/Unit Delay2'

            ANAS0_DW.IdentityMatrix_h[i] =
                ANAS0_P.IdentityMatrix_IDMatrixData[i];
        }

        // End of SystemInitialize for SubSystem: '<S9>/Active Correction Step
        // Magnetometer' End of SystemInitialize for SubSystem: '<S8>/Active
        // Correction Step Accelerometer'
        ...
        // SystemInitialize for Atomic SubSystem: '<S1>/Linear States
        // Corrections' InitializeConditions for Memory: '<S203>/Memory'
        ...
        // SystemInitialize for Enabled SubSystem: '<S97>/Active Correction Step
        // GPS' Start for IdentityMatrix: '<S215>/Identity Matrix'
        std::memcpy(&ANAS0_DW.IdentityMatrix[0],
                    &ANAS0_P.IdentityMatrix_IDMatrixData_m[0],
                    sizeof(float) << 4U);

        // End of SystemInitialize for SubSystem: '<S97>/Active Correction Step
        // GPS'

        // SystemInitialize for Enabled SubSystem: '<S96>/Active Correction Step
        // Baro & Variometer ' InitializeConditions for DiscreteFilter:
        // '<S116>/Discrete Filter'
        ...
        ANAS0_DW.IdentityMatrix_eg[0] =
            ANAS0_P.IdentityMatrix_IDMatrixData_i[0];

        // End of SystemInitialize for SubSystem: '<S96>/Active Correction Step
        // Baro & Variometer '

        // SystemInitialize for Enabled SubSystem: '<S96>/Active Correction Step
        // Main Static & Pitot' Start for IdentityMatrix: '<S136>/Identity
        // Matrix'
        ...
        // SystemInitialize for Enabled SubSystem: '<S96>/Active Correction Step
        // Pitot Static & Differential' Start for IdentityMatrix:
        // '<S156>/Identity Matrix'
        ANAS0_DW.IdentityMatrix_n[0] = ANAS0_P.IdentityMatrix_IDMatrixData_p[0];

        // End of SystemInitialize for SubSystem: '<S96>/Active Correction Step
        // Pitot Static & Differential'

        // SystemInitialize for Enabled SubSystem: '<S96>/Active Correction Step
        // Baro & Variometer ' Start for IdentityMatrix: '<S115>/Identity
        // Matrix'
        ANAS0_DW.IdentityMatrix_eg[1] =
            ANAS0_P.IdentityMatrix_IDMatrixData_i[1];
        ...
        // Baro & Variometer ' Start for IdentityMatrix: '<S115>/Identity
        // Matrix'
        ANAS0_DW.IdentityMatrix_eg[2] =
            ANAS0_P.IdentityMatrix_IDMatrixData_i[2];
        ...
        // Baro & Variometer ' Start for IdentityMatrix: '<S115>/Identity
        // Matrix'
        ANAS0_DW.IdentityMatrix_eg[3] =
            ANAS0_P.IdentityMatrix_IDMatrixData_i[3];
        ...
        // SystemInitialize for Enabled SubSystem: '<S96>/Active Correction Step
        // Static Main' Start for IdentityMatrix: '<S172>/Identity Matrix'
        ...
        // SystemInitialize for Enabled SubSystem: '<S96>/Active Correction Step
        // Static Pitot' Start for IdentityMatrix: '<S185>/Identity Matrix'
        ...
        // End of SystemInitialize for SubSystem: '<S1>/Linear States
        // Corrections' End of SystemInitialize for SubSystem: '<Root>/ANAS'
    }
}
...
// Constructor
ANAS0::ANAS0() : ANAS0_U(), ANAS0_Y(), ANAS0_DW(), ANAS0_M()
{
...
ANAS0::RT_MODEL_ANAS0_T* ANAS0::getRTM() { return (&ANAS0_M); }
