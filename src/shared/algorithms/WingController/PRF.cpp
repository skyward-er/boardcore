...
void PRF::step()
{
  ...
  if ((PRF_DW.UnitDelay1_DSTATE > 0) &&
    ...
    //   Inport: '<Root>/PRF Wind'

    if (PRF_U.PRFWind > PRF_P.WrapToZero_Threshold) {
      rtb_Sum2_idx_0 = PRF_P.Constant_Value_k;
    } else {
      rtb_Sum2_idx_0 = PRF_U.PRFWind;
    }
  ...
  rtb_Sum2_idx_0 = std::abs(PRF_P.Constant1_Value_e[0] -
  ...
  rtb_Sum2_idx_0 = std::abs(PRF_P.Constant1_Value_e[1] -
