...
class PRF final
{
 ...
 public:
  ...
  struct P_PRF_T {
    ...
    float Constant1_Value_e[2];        // Computed Parameter: Constant1_Value_e
  ...
  // Root inport: '<Root>/PRF Wind' set method
  void setPRF_Wind(float localArgInput)
  {
    PRF_U.PRFWind = localArgInput;
  }
