...
extern uint32_t plook_u32ff_evenx(float u, float bp0, float bpSpace,
                                  uint32_t maxIndex, float* fraction);
extern uint8_t plook_u8f_evencka(float u, float bp0, float bpSpace,
                                 uint32_t maxIndex);
extern uint16_t plook_u16ff_binc(float u, const float bp[], uint32_t maxIndex,
                                 float* fraction);
extern uint16_t plook_u16fdf_evenx(float u, double bp0, double bpSpace,
                                   uint32_t maxIndex, float* fraction);
